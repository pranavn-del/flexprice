...
// QuickBooksInvoiceSyncWorkflowInput contains the input for the QuickBooks invoice sync workflow
type QuickBooksInvoiceSyncWorkflowInput struct {
...
func (input *QuickBooksInvoiceSyncWorkflowInput) Validate() error {
	if input.InvoiceID == "" {
