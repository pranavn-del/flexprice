...
// RazorpayInvoiceSyncWorkflowInput contains the input for the Razorpay invoice sync workflow
type RazorpayInvoiceSyncWorkflowInput struct {
...
func (input *RazorpayInvoiceSyncWorkflowInput) Validate() error {
	if input.InvoiceID == "" {
